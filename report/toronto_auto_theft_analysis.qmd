---
title: "Toronto Auto Theft Analysis: Insurance Risk Assessment and Premium Optimization"
...
- Key Variables:
  ...
  - Insurance-relevant: Claim processing time, recovery status (where available)
...
1. **Auto Theft Pipeline** (`auto_theft_pipeline.py`)
   - Cleaned and validated insurance claim incident data
   ...
   - Generated derived features (time bins, seasons, weekend indicators) for insurance risk modeling
...
1. **Auto Theft Claims Data Cleaning**
   ...
   - Imputed missing neighborhood information using modal neighborhoods for each insurance service area
...
### Validation and Insurance Standards Compliance
...
- **Actuarial Data Quality Standards**: All data processing followed OSFI (Office of the Superintendent of Financial Institutions) and IBC (Insurance Bureau of Canada) guidelines for statistical credibility.
